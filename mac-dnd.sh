...
# notification center's .plist file to toggle the mode. A bug is that when
# disabling the mode, the notification center's icon in the menu bar stays
# greyed out. 

# based on: https://gist.github.com/ryangreenberg/5267f68a8e7b07ea66370b4eb5580ab9
# 
# original code:
# #!/bin/bash
...
then
  ...
  # When deactivating "by hand" the doNotDisturbDate field is removed, this was
